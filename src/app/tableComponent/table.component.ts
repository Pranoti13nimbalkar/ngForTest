...
import { bookInfo,courseInfo, customerInfo, EmployeeInfo, movieInfo, orderInfo, productInfo, studentArrIntr, teacherInfo, vehicleInfo } from "../models/employee";
...
export class TableComponent{
  empArr: Array<EmployeeInfo> = [
    ...
    studentArr: Array<studentArrIntr> = [
...
bookArr :Array<bookInfo>= [
 ...
 customerArr :Array<customerInfo>= [
