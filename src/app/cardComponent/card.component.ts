...
import { aiCard, biologyArr, businessArr, cloudArr, educationArr, geographyArr, mathArr, psychologyArr, roboticsArr, techToolsArr } from "../models/aiCard";
...
geographyArr: Array<geographyArr> = [
 ...
 psychologyArr: Array<psychologyArr> = [
...
techToolsArr: Array<techToolsArr> = [
...
educationArr: Array <educationArr> = [
